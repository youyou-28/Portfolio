          ...
          <section className="mb-16">
            ...
            <div className="space-y-12">
              {[
                ...
                // ... Rest of the competencies with their details
              ].map((competence, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <h3 className="text-2xl font-bold text-indigo-600 mb-6">{competence.title}</h3>
                  ...
                  <div className="mb-8">
                    ...
                    <ul className="list-disc pl-6 space-y-3">
                      {competence.proofs.map((proof, i) => (
                        <li key={i} className="text-gray-600 hover:text-indigo-600 transition-colors">
                          {proof}
                        </li>
                      ))}
                    </ul>
                  ...
                  <div>
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {competence.skills.map((skill, i) => (
                        <li key={i} className="bg-gray-50 p-4 rounded-lg hover:bg-indigo-50 transition-colors">
                          {skill}
                        </li>
                      ))}
                    </ul>
